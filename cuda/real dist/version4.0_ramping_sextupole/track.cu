...
//	part[0].x[0]=1E-5;part[0].x[1]=0.000;part[0].x[2]= 1E-5;part[0].x[3]=0.000;part[0].x[5]=0.001;
...
//Initiate lattice
	...
	emittance(part,&Ex,&Ey,&Sdelta);
     ...
     outfile<<setw(4)<<n<<scientific<<setw(15)<<Ex<<scientific<<setw(15)<<Ey<<setw(15)<<scientific<<Sdelta<<endl;
